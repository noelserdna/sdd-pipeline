...
export const GAPS_TOOL = {
    name: "sdd_gaps",
    description: "Read gap analysis results from .sdd/gap-analysis.json. Filters by category (missing, orphan, mismatch) and returns summary or detailed findings. Use after running /sdd-gap-detector.",
    inputSchema: {
        type: "object",
        properties: {
            category: {
                type: "string",
                description: 'Filter by gap category: "missing" | "orphan" | "mismatch" | "all" (default: "all")',
            },
            format: {
                type: "string",
                description: 'Output format: "summary" (stats + top issues) or "detail" (all findings). Default: "summary"',
            },
        },
    },
};
...
// Execution
// ---------------------------------------------------------------------------
export function executeGaps(args) {
